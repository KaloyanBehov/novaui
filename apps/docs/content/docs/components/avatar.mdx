...
<ComponentPreview>
  <div className="flex items-center gap-4">
    <div className="relative flex h-10 w-10 shrink-0 overflow-hidden rounded-full">
      <img src="https://github.com/vercel.png" alt="Avatar" className="aspect-square h-full w-full" />
    </div>
    <div className="relative flex h-10 w-10 shrink-0 overflow-hidden rounded-full">
...
The Avatar component is installed via the CLI into your `@/components/ui` folder. Make sure you have the required peer dependencies installed:
