...
export default function TrendingScreen() {
  ...
  // For demo purposes, we'll take a middle slice and mix it up a bit
  const data = bestSellers.slice(2, 12);
  ...
  return (
    <SafeAreaView className="bg-background flex-1" edges={['top']}>
      ...
      <View className="flex-row items-center px-4 pb-2 pt-2">
        ...
        <H1 className="text-foreground text-xl font-bold">Trending</H1>
      </View>
