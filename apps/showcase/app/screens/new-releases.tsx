...
export default function NewReleasesScreen() {
  ...
  // For demo purposes, we'll take the last 10 items to make it look different
  const data = [...bestSellers].reverse().slice(0, 10);
  ...
  return (
    <SafeAreaView className="bg-background flex-1" edges={['top']}>
      ...
      <View className="flex-row items-center px-4 pb-2 pt-2">
        ...
        <H1 className="text-foreground text-xl font-bold">New Releases</H1>
      </View>
