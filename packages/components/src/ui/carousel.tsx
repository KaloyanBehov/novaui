...
function Carousel({
  ...
  const handleScroll = React.useCallback(
    (event: NativeSyntheticEvent<NativeScrollEvent>) => {
      ...
      const layoutSize =
        orientation === 'horizontal' ? layoutMeasurement.width : layoutMeasurement.height;
  ...
  return (
    <CarouselContext.Provider
      value={{
        carouselRef: carouselRef as React.RefObject<ScrollView>,
        orientation,
        scrollPrev,
        scrollNext,
        canScrollPrev,
      ...
      <View className={cn('relative', className)} role="region" aria-label="carousel" {...props}>
        <ScrollView
          ref={carouselRef}
