...
const ScrollArea = React.forwardRef<React.ElementRef<typeof ScrollView>, ScrollAreaProps>(
  (
    { className, viewportClassName, children, onScroll, onContentSizeChange, onLayout, ...props },
    ref
  ) => {
...
const ScrollBar = React.forwardRef<React.ElementRef<typeof View>, ScrollBarProps>(
  ({ className, orientation = 'vertical', ...props }, ref) => {
    ...
    const scrollRange = isVertical ? contentHeight - viewportHeight : contentWidth - viewportWidth;
    ...
    return (
      <View
        ...
        {...props}>
        <View
          className={cn('bg-border rounded-full', isVertical ? 'w-full' : 'h-full')}
          style={
            isVertical
              ? {
                  position: 'absolute',
