...
import { Modal, View, TouchableWithoutFeedback, Platform, StyleSheet } from "react-native"
...
>(({ open: controlledOpen, onOpenChange: controlledOnOpenChange, defaultOpen = false, children, ...props }, ref) => {
    ...
    >
      <View className="flex-1 justify-center items-center bg-black/50">
        ...
        <Animated.View
          ...
          exiting={FadeOut}
          className={cn(
            "z-50 w-[90%] max-w-lg gap-4 border border-border bg-background p-6 shadow-lg rounded-lg",
            className
          )}
          {...props}
        >
