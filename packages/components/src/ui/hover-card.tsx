...
const HoverCard = ({ children, open: controlledOpen, onOpenChange: setControlledOpen, defaultOpen = false }: { children: React.ReactNode, open?: boolean, onOpenChange?: (open: boolean) => void, defaultOpen?: boolean }) => {
        ...
        >
            ...
            >
                ...
                >
                     <View 
                        ref={ref}
                        className={cn("z-50 w-64 rounded-md border border-border bg-popover p-4 shadow-md outline-none", className)} 
                        {...props}
                     >
                        {children}
                     </View>
